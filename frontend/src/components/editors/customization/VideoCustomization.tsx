...
const BackgroundVideo = ({ value, onChange }: SelectorProps) => {
...
const Voice = ({ value, onChange }: SelectorProps) => {
...
const Theme = ({ value, onChange }: SelectorProps) => (
  <Select value={value} onValueChange={onChange}>
      <SelectTrigger id="theme-select" className={`mt-2`}><SelectValue placeholder="Select a theme..." /></SelectTrigger>
